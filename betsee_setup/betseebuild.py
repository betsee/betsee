...
# ....................{ IMPORTS                            }....................
from betsee_setup import betseeutil
...
# monkey-patched by the BETSEE-specific "betsee_setup.build" submodule.
#
...
def _patched_get_args(
    ...
    **entry points** (i.e., platform-specific executables running this
    ...
    for script_basename, script_type, entry_point in (
        betseeutil.package_distribution_entry_points(distribution)):
