...
"}")
        ...
        self.sim_cmd_run_state_bar = QtWidgets.QProgressBar(self.sim_cmd_run_state)
        self.sim_cmd_run_state_bar.setAlignment(QtCore.Qt.AlignCenter)
        self.sim_cmd_run_state_bar.setObjectName("sim_cmd_run_state_bar")
        self.verticalLayout.addWidget(self.sim_cmd_run_state_bar)
...
"</p></body></html>", None, -1))
        ...
        self.sim_cmd_run_state_bar.setToolTip(QtWidgets.QApplication.translate("main_window", "Percentage completed of the action being applied to the currently queued simulation phase.", None, -1))
