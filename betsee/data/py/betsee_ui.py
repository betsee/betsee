...
"}")
        ...
        self.sim_cmd_run_queue = QtWidgets.QTableWidget(self.groupBox_19)
        self.sim_cmd_run_queue.setAutoFillBackground(True)
        self.sim_cmd_run_queue.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.sim_cmd_run_queue.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContents)
        self.sim_cmd_run_queue.setObjectName("sim_cmd_run_queue")
        self.sim_cmd_run_queue.setColumnCount(4)
        self.sim_cmd_run_queue.setRowCount(3)
        item = QtWidgets.QTableWidgetItem()
        self.sim_cmd_run_queue.setVerticalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.sim_cmd_run_queue.setVerticalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.sim_cmd_run_queue.setVerticalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.sim_cmd_run_queue.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.sim_cmd_run_queue.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.sim_cmd_run_queue.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.sim_cmd_run_queue.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.sim_cmd_run_queue.setItem(0, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.sim_cmd_run_queue.setItem(0, 3, item)
        item = QtWidgets.QTableWidgetItem()
        self.sim_cmd_run_queue.setItem(1, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.sim_cmd_run_queue.setItem(1, 3, item)
        item = QtWidgets.QTableWidgetItem()
        self.sim_cmd_run_queue.setItem(2, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.sim_cmd_run_queue.setItem(2, 3, item)
        self.sim_cmd_run_queue.horizontalHeader().setCascadingSectionResizes(True)
        self.sim_cmd_run_queue.horizontalHeader().setStretchLastSection(True)
        self.sim_cmd_run_queue.verticalHeader().setVisible(False)
        self.sim_cmd_run_queue.verticalHeader().setCascadingSectionResizes(True)
        self.verticalLayout_2.addWidget(self.sim_cmd_run_queue)
        self.gridLayout_30.addWidget(self.groupBox_19, 1, 0, 1, 1)
        ...
        icon18 = QtGui.QIcon()
        icon18.addFile(":/icon/betsee/document_open.svg", QtCore.QSize(), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_open_sim.setIcon(icon18)
        ...
        icon19 = QtGui.QIcon()
        icon19.addFile(":/icon/open_iconic/document.svg", QtCore.QSize(), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_save_sim.setIcon(icon19)
        ...
        icon20 = QtGui.QIcon()
        icon20.addFile(":/icon/open_iconic/wrench.svg", QtCore.QSize(), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_edit_prefs.setIcon(icon20)
        ...
        icon21 = QtGui.QIcon()
        icon21.addFile(":/icon/open_iconic/file.svg", QtCore.QSize(), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_make_sim.setIcon(icon21)
        ...
        icon22 = QtGui.QIcon()
        icon22.addFile(":/icon/entypo+/scissors.svg", QtCore.QSize(), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_cut.setIcon(icon22)
        self.action_cut.setObjectName("action_cut")
        self.action_copy = QtWidgets.QAction(main_window)
        icon23 = QtGui.QIcon()
        icon23.addFile(":/icon/entypo+/copy.svg", QtCore.QSize(), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_copy.setIcon(icon23)
        self.action_copy.setObjectName("action_copy")
        self.action_paste = QtWidgets.QAction(main_window)
        icon24 = QtGui.QIcon()
        icon24.addFile(":/icon/entypo+/clipboard.svg", QtCore.QSize(), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_paste.setIcon(icon24)
        ...
        icon28 = QtGui.QIcon()
        icon28.addFile(":/icon/open_iconic/media-play.svg", QtCore.QSize(), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon28.addFile(":/icon/open_iconic/media-pause.svg", QtCore.QSize(), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.action_sim_cmd_toggle.setIcon(icon28)
        ...
        self.action_sim_cmd_halt.setIcon(icon29)
...
"</p></body></html>", None, -1))
        ...
        self.sim_cmd_run_state_substatus.setText(QtWidgets.QApplication.translate("main_window", "phase substatuses", None, -1))
        ...
        self.groupBox_19.setToolTip(QtWidgets.QApplication.translate("main_window", "<html><head/><body><p>Queue (i.e., ordered list) of all simulation phases to be iteratively modelled and/or exported when the <img src=\":/icon/open_iconic/media-play.svg\"/> button is clicked, complete with a terse synopsis of the current state of these phases.</p></body></html>", None, -1))
        self.groupBox_19.setTitle(QtWidgets.QApplication.translate("main_window", "Phase Queue", None, -1))
        self.sim_cmd_run_queue.verticalHeaderItem(0).setText(QtWidgets.QApplication.translate("main_window", "Seed", None, -1))
        self.sim_cmd_run_queue.verticalHeaderItem(1).setText(QtWidgets.QApplication.translate("main_window", "Initialization", None, -1))
        self.sim_cmd_run_queue.verticalHeaderItem(2).setText(QtWidgets.QApplication.translate("main_window", "Simulation", None, -1))
        self.sim_cmd_run_queue.horizontalHeaderItem(0).setText(QtWidgets.QApplication.translate("main_window", "Phase", None, -1))
        self.sim_cmd_run_queue.horizontalHeaderItem(1).setText(QtWidgets.QApplication.translate("main_window", "Model?", None, -1))
        self.sim_cmd_run_queue.horizontalHeaderItem(2).setText(QtWidgets.QApplication.translate("main_window", "Export?", None, -1))
        self.sim_cmd_run_queue.horizontalHeaderItem(3).setText(QtWidgets.QApplication.translate("main_window", "Status", None, -1))
        __sortingEnabled = self.sim_cmd_run_queue.isSortingEnabled()
        self.sim_cmd_run_queue.setSortingEnabled(False)
        self.sim_cmd_run_queue.item(0, 0).setText(QtWidgets.QApplication.translate("main_window", "Seed", None, -1))
        self.sim_cmd_run_queue.item(0, 3).setText(QtWidgets.QApplication.translate("main_window", "Unqueued", None, -1))
        self.sim_cmd_run_queue.item(1, 0).setText(QtWidgets.QApplication.translate("main_window", "Initialization", None, -1))
        self.sim_cmd_run_queue.item(1, 3).setText(QtWidgets.QApplication.translate("main_window", "Unqueued", None, -1))
        self.sim_cmd_run_queue.item(2, 0).setText(QtWidgets.QApplication.translate("main_window", "Simulation", None, -1))
        self.sim_cmd_run_queue.item(2, 3).setText(QtWidgets.QApplication.translate("main_window", "Unqueued", None, -1))
        self.sim_cmd_run_queue.setSortingEnabled(__sortingEnabled)
