...
class QBetseeSimConfLineEdit(
    ...
    def widget_value(self, widget_value: str) -> None:
        ...
        # (due to their implementation of the special __str__() method), this
        # is guaranteed to be safe and hence need *NOT* be checked.
...
class QBetseeSimConfPathnameImageLineEdit(QBetseeSimConfPathnameLineEditABC):
    ...
    def _get_alias_from_widget_value(self) -> object:
        ...
        # This widget's currently displayed value, equivalent to the relative
        # or absolute filename of the expected image.
    ...
    def _select_pathname(self, init_pathname: str) -> StrOrNoneTypes:
        ...
        # Return the absolute or relative filename of an existing selected
        # image of the parent directory containing the current simulation
